...
fr.depdownload_msg=Les applications suivantes sont nécessaires avant que le programme d'installation puisse continuer : %n%n%1%n Téléchargez et installez maintenant ?

en.depdownload_memo_title=Download dependencies
de.depdownload_memo_title=Abhängigkeiten downloaden
fr.depdownload_memo_title=Téléchargez les dépendances
...
fr.depinstall_description=Veuillez patienter pendant que le programme d'installation installe des dépendances sur votre ordinateur.
...
fr.depinstall_missing=%1 doit être installé avant l'installation peut se poursuivre. Veuillez installer %1 et relancez le programme d'installation.
...
fr.depinstall_error=Une erreur s'est produite lors de l'installation des dépendances. Veuillez redémarrer l'ordinateur et relancez l'installation ou installer manuellement les dépendances suivantes:%n
