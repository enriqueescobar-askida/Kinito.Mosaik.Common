// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ResponseFilterRobotsStream.cs" company="AlphaMosaik">
//   Copyright (c) AlphaMosaik. All rights reserved.
// </copyright>
// <summary>
//   Defines the ResponseFilterRobotsStream type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
{
    public class ResponseFilterRobotsStream : Stream
    {
        ...
        public ResponseFilterRobotsStream(Stream responseStream, TranslatorHelper.TranslatorHelper translatorHelper, string languageCode, string siteUrl)
        {
        ...
        public override void Flush()
        {
            if (_html.Length > 0)
            {
                try
                {
                    _translatorHelper.RobotWrite(_html, _responseStream, _siteUrl);
                }
                catch (Exception exc)
                {
                    ...
                    Utilities.LogException("RobotWrite", exc, EventLogEntryType.Warning);
                }
            }
