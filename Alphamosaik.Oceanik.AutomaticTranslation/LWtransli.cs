// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LWtransli.cs" company="AlphaMosaik">
...
namespace Alphamosaik.Oceanik.AutomaticTranslation
{
    ...
    public class LWTRANSLI
    {
        ...
        private const String SERVER_URL_EN_FR = "http://moon.dyndns.org:4640";
        private const String SERVER_URL_FR_EN = "http://moon.dyndns.org:4644";

        public LWTRANSLI(string srcLang, string tgtLang)
        {
            _server = new LWQueue();        
            _server.Url = SERVER_URL_EN_FR;
            if ((srcLang == "fra") && (tgtLang == "eng"))
                _server.Url = SERVER_URL_FR_EN;
        }
        ...
        public int translate_File(String filename, String fileType, String encoding, String srcLang, String tgtLang, String user, Boolean unknown)
        {
            ...
            using(FileStream file = new FileStream(filename, FileMode.Open))
            {
                ...
                jobID = _server.createJob(param, context, buffer);
            }
