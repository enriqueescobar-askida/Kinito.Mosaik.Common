...
<%@ Page Language="C#" Inherits="AlphaMosaik.Logger.Administration.ApplicationPages.ConfigureSqlLogProviderPage" MasterPageFile="~/_admin/admin.master" EnableViewState="true" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
       ...
       <AlphaMosaik:SqlProviderSection runat="server" ID="SqlProviderSection" />
    </table>
</asp:Content>
