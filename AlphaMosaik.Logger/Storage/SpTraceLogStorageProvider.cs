...
{
    public class SpTraceLogStorageProvider : BaseStorageProvider
    {
        ...
        {
            throw new NotImplementedException();
            //ConfManager.SetSetting(webApp, Properties.Settings.Default.Settings_Storage_SpTraceLogProvider_Enabled, this.Enabled.ToString());
